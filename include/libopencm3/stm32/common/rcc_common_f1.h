/** @addtogroup rcc_defines RCC Defines
 *
...
/** @cond */
#if defined(LIBOPENCM3_RCC_H)
/** @endcond */
#ifndef LIBOPENCM3_RCC_COMMON_F1_H
#define LIBOPENCM3_RCC_COMMON_F1_H
...
/** @cond */
#else
#warning "rcc_common_f1.h should not be included directly, only via rcc.h"
#endif
/** @endcond */
